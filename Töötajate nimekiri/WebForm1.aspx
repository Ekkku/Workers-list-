<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Töötajate_nimekiri.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="Label4" runat="server" Text="Osakond"></asp:Label>
